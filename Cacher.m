...
- (void)cacheImage:(UIImage *)image forPhoto:(NSDictionary *)photo
{
    ...
    NSString *filePath = [self.directoryPath stringByAppendingPathComponent:[photo objectForKey:@"id"]];
...
{
    NSData *contents = [[NSFileManager defaultManager] contentsAtPath:[self.directoryPath stringByAppendingPathComponent:[photo valueForKey:@"id"]]];
